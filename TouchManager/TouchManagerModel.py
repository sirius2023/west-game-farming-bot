...
from model.utils import loadJsonData, saveJsonData_oneIndent, saveJsonData_twoIndent, readAllSizesFolders, getCoordFilePath
...
class TouchManagerModel(QObject):
    ...
    def __init__(self):
        ...
        self.currentScreensFolder = "1280x720"
