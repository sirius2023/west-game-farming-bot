...
from TouchManager.usbconnecter import UsbConnector
from TouchManager.screenconnector import GameScreenConnector
from TouchManager.statisticmgr import StatisticsManager
from model.utils import loadJsonData, saveJsonData_oneIndent, saveJsonData_twoIndent, readAllSizesFolders, buildDataFolder, \
    getCoordFilePath
import enum
...
class CaveEngine(QObject):
    ...
    def __init__(self, connectImmediately: bool = False):
        ...
        self.width, self.heigth = 1280, 720
